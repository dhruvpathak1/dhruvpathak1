<div align="center">
  ...
  <p align="center">
    <b>Student Liaison Leader @ AI Collective</b> | <b>Director @ HackCU</b><br>
...
I'm a Graduate from **University of Colorado Boulder** with an **MS in Computer Science**. My journey in tech is driven by a fascination for building secure, intelligent systems that bridge the gap between complex code and real-world impact.

- 🎓 Recently completed my **Master's in Computer Science** at **CU Boulder**.
- 🛡️ Specialized in **Cybersecurity, Cloud Security, Risk Management, and Automation**.
- 🚀 Leading outreach for **AI Collective** and operational efforts for **HackCU**.
- 🎾 Outside of tech, I love exploring the mountains on a hiking trail, capturing the world through doodling and drawing, or catching the latest thriller.
...
![Scapy](https://img.shields.io/badge/Scapy-3178C6?style=flat-square&logo=python&logoColor=white)
...
![REST API](https://img.shields.io/badge/REST%20API-005571?style=flat-square&logo=google-cloud&logoColor=white)
![Git](https://img.shields.io/badge/Git-F05032?style=flat-square&logo=git&logoColor=white)
![Netcat](https://img.shields.io/badge/Netcat-000000?style=flat-square&logo=linux&logoColor=white)
...
- **Operational Excellence:** Overseeing the end-to-end operational framework for one of the largest collegiate hackathons in the Rockies (HackCU 12).
- **Automation:** Built an automated system reaching 3,000+ subscribers with streamlined distribution for the HackCU Newsletter.
- **Community Growth:** Supporting industry outreach, event promotion, and end-to-end logistics to enhance the hackathon experience for 250+ participants.
